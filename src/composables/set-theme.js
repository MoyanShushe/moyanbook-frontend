import { Hct, hexFromArgb, themeFromSourceColor } from '@material/material-color-utilities'
...
export function useSetTheme() {
  watchEffect(() => {
    ...
    Object.keys(colors).forEach((key) => {
      document.documentElement.style.setProperty(`--m-${key}`, hexFromArgb(colors[key]))
    })
    document.querySelector('meta[name="theme-color"]').setAttribute('content', hexFromArgb(colors['sur-c-high']))
  })
}
